...
import com.cherifi.acnhcheatsgenerator.adapters.MyItemRecyclerViewAdapter
...
class ItemFragment : Fragment() {
    ...
    private lateinit var items: MutableList<Pair<String, String>>
